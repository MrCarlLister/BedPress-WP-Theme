...
<section class="py-20 px-5 bg-gray-darker md:grid md:grid-rows-2 grid-cols-12">
...
<?php wp_enqueue_script('bespokeSliderLibrary'); wp_enqueue_script('bespokeSliderController'); ?>
